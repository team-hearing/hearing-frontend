...
export default function DetailPage({ params }: { 
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        {/* 1 페이지 */}
        <div className="min-w-full w-screen h-screen flex items-start snap-start px-4 sm:px-6 md:px-8 lg:px-12 pt-24 sm:pt-20 md:pt-16 pb-8 max-w-screen-2xl mx-auto overflow-y-auto">
          <IntroPage 
            title={post.title}
